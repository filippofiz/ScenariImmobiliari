    ...
    <div className="min-h-screen bg-bg">
      ...
      <header className="border-b border-border bg-bg-card">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-heading text-lg font-semibold text-text-primary">Admin Panel</h1>
              <p className="text-[11px] text-text-muted font-mono">Scenari Immobiliari</p>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <section className="bg-bg-card border border-border rounded-2xl p-6">
          <h2 className="font-heading text-xl text-text-primary mb-1">Carica Documento</h2>
        ...
        {/* Documents List */}
        <section className="bg-bg-card border border-border rounded-2xl p-6">
          <h2 className="font-heading text-xl text-text-primary mb-4">Documenti Indicizzati</h2>
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              {documents.map(doc => (
                <div key={doc.id} className="flex items-center justify-between bg-bg border border-border rounded-xl px-4 py-3">
                  <div className="flex items-center gap-3">
        ...
        {/* Info */}
        <section className="text-center text-xs text-text-muted/40 font-mono py-4">
